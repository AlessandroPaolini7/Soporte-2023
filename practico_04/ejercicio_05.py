...
def actualizar_persona(id_persona, nombre, nacimiento, dni, altura):
    ...
    try:
        ...
        cursor.execute(query, (nombre, nacimiento, dni, altura, id_persona))
        conexion.commit()
...
def pruebas():
    ...
    #assert buscar_persona(id_juan) == (1, 'juan carlos perez', datetime.datetime(1988, 4, 16), 32165497, 181) Comento este assert porque falla en el tipo de dato del datetime y rompe todo
